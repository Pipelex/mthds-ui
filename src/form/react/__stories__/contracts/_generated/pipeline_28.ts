...
export const CONTRACTS_CV_BATCH_SCREENING = {
  ...
  "cv_batch_screening.analyze_match": {
    ...
    output: {
      ...
      json_schema: {
        ...
        title: "cv_batch_screening.CandidateMatch",
        type: "object",
      },
      multiplicity: "single",
      optional: false,
  ...
  "cv_batch_screening.batch_analyze_cvs_for_job_offer": {
    ...
    output: {
      ...
      json_schema: {
        $defs: {
          cv_batch_screening__CandidateMatch: {
            description: "An evaluation of how well a candidate fits a job position.",
            properties: {
              gaps: {
                description: "Areas where the candidate falls short of requirements",
              ...
              match_score: {
                description:
                  "Numerical score representing overall fit percentage between 0 and 100",
                title: "Match Score",
                type: "number",
              },
              overall_assessment: {
        ...
        properties: {
          items: {
            items: {
              $ref: "#/$defs/cv_batch_screening__CandidateMatch",
            },
            title: "Items",
            type: "array",
          },
        ...
        required: ["items"],
        title: "ListContent[cv_batch_screening__CandidateMatch]",
        type: "object",
      },
      multiplicity: "variable",
      optional: false,
...
export const OUTPUT_FORM_CV_BATCH_SCREENING = {
  "cv_batch_screening.analyze_job_requirements": {
    field: {
      concept_ref: "cv_batch_screening.JobRequirements",
      description: "A structured summary of what a job position requires from candidates.",
