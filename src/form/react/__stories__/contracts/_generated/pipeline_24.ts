...
export const CONTRACTS_DEEP_NESTING = {
    ...
    output: {
      ...
      json_schema: {
        ...
        properties: {
          items: {
            items: {
              $ref: "#/$defs/deep_processing__BatchResult",
            },
            title: "Items",
            type: "array",
          },
        ...
        required: ["items"],
        title: "ListContent[deep_processing__BatchResult]",
        type: "object",
      },
      multiplicity: "variable",
      optional: false,
  ...
  "deep_processing.deep_nested_pipeline": {
    ...
    output: {
      ...
      json_schema: {
        ...
        required: ["text"],
        title: "deep_processing.FinalOutput",
        type: "object",
      },
      multiplicity: "single",
      optional: false,
...
export const INPUT_FORM_DEEP_NESTING = {
  "deep_processing.batch_branch": {
    fields: [
      {
        concept_ref: "native.Page",
...
export const OUTPUT_FORM_DEEP_NESTING = {
  "deep_processing.batch_branch": {
    field: {
      concept_ref: "deep_processing.BatchResult",
      description: "Result from batch processing",
