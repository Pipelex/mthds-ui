...
export const CONTRACTS_CV_ANALYZER = {
  ...
  "candidate_screening.generate_interview_questions": {
    ...
    output: {
      ...
      json_schema: {
        $defs: {
          candidate_screening__InterviewQuestion: {
            description:
        ...
        properties: {
          items: {
            items: {
              $ref: "#/$defs/candidate_screening__InterviewQuestion",
            },
            maxItems: 5,
            minItems: 5,
            title: "Items",
        ...
        required: ["items"],
        title: "ListContent[candidate_screening__InterviewQuestion]",
        type: "object",
      },
      multiplicity: "fixed",
      optional: false,
  ...
  "candidate_screening.write_refusal_email": {
    ...
    output: {
      ...
      json_schema: {
        ...
        required: ["text"],
        title: "candidate_screening.Email",
        type: "object",
      },
      multiplicity: "single",
      optional: false,
...
export const INPUT_FORM_CV_ANALYZER = {
  "candidate_screening.analyze_match": {
    fields: [
      {
        concept_ref: "native.Page",
...
export const OUTPUT_FORM_CV_ANALYZER = {
  "candidate_screening.analyze_match": {
    field: {
      concept_ref: "candidate_screening.DetailedMatchResult",
      description:
