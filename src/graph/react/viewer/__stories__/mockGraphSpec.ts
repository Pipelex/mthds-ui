...
// All specs are generated from real pipelex output by scripts/generate-fixtures.mjs.
// DRY specs:  `make fixtures`                  -> _generated.dry.ts
// LIVE specs: `FIXTURES_LIVE=1 make fixtures`  -> _generated.live.ts
// Both sets are sourced from the bundles in data/pipelines/.
...
export const LIVE_RUN_CATALOG: Record<string, { label: string; spec: GraphSpec }> = {
  ...
  LIVE_CV_MATCHING: { label: "26 - CV Matching (Condition + Compose)", spec: LIVE_CV_MATCHING },
  LIVE_CV_BATCH_SCREENING: { label: "28 - CV Batch Screening", spec: LIVE_CV_BATCH_SCREENING },
  LIVE_CV_ANALYZER: { label: "30 - CV Analyzer (Concept Refinement)", spec: LIVE_CV_ANALYZER },
  LIVE_RFP_QUALIFIER: {
