...
import { DRY_RAG_PIPELINE } from "./specs/_generated/dry/pipeline_15";
...
const D = {
  ...
  renderStuffData: stuffRendererFor("RAG_PIPELINE"),
};

export const DryRun: Story = {
  args: { graphspec: DRY_RAG_PIPELINE, ...D },
};

export const LiveRun: Story = {
  args: { graphspec: LIVE_RAG_PIPELINE, ...D },
};
