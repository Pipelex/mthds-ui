  ...
  nodes: [
    {
        ...
        outputs: [
          {
            ...
            data_text:
              "APPROVED: Both text and image content passed safety checks with high safety scores (0.95 each). No  \ncategories were flagged in either text or image analysis.                                           \n",
            data_html:
              "APPROVED: Both text and image content passed safety checks with high safety scores (0.95 each). No categories were flagged in either text or image analysis.",
            extra: {},
          },
        ],
      },
      ...
      usage: {
        ...
        subtree_total_tokens: 3000,
        subtree_cost: 0.0114,
        subtree_cost_input: 0.0084,
        subtree_cost_output: 0.003,
        subtree_by_model: [
          {
    ...
    },
    {
      ...
      io: {
        ...
        outputs: [
          ...
          },
          {
            ...
            data_html:
              "<table><tr><th>text_score</th><td><table><tr><th>score</th><td>0.95</td></tr><tr><th>safe</th><td>True</td></tr></table></td></tr><tr><th>image_score</th><td><table><tr><th>score</th><td>0.95</td></tr><tr><th>safe</th><td>True</td></tr></table></td></tr></table>",
            extra: {},
          },
        ],
      },
      ...
      usage: {
        ...
        subtree_cost: 0.007239,
        subtree_cost_input: 0.005679,
        subtree_cost_output: 0.00156,
        subtree_by_model: [
          {
            inference_model_name: "claude-4.6-sonnet",
            inference_model_id: "global.anthropic.claude-sonnet-4-6",
    ...
    },
    {
      ...
      usage: {
        ...
        subtree_total_tokens: 1002,
        subtree_cost: 0.00363,
        subtree_cost_input: 0.00285,
        subtree_cost_output: 0.00078,
        subtree_by_model: [
          {
            inference_model_name: "claude-4.6-sonnet",
            inference_model_id: "global.anthropic.claude-sonnet-4-6",
    ...
    },
    {
      ...
      usage: {
        ...
        subtree_total_tokens: 995,
        subtree_cost: 0.003609,
        subtree_cost_input: 0.002829,
        subtree_cost_output: 0.00078,
        subtree_by_model: [
          {
            inference_model_name: "claude-4.6-sonnet",
    ...
    },
    {
        ...
        outputs: [
          {
            ...
            data: {
              approved: true,
              reason:
                "Both text and image content passed safety checks with high safety scores (0.95 each). No categories were flagged in either text or image analysis.",
              action: "approve",
            },
            data_text:
              " Attribute ┃ Value                                                              \n━━━━━━━━━━━╇━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\n approved  │ True                                                               \n───────────┼────────────────────────────────────────────────────────────────────\n reason    │ Both text and image content passed safety checks with high safety  \n           │ scores (0.95 each). No categories were flagged in either text or   \n           │ image analysis.                                                    \n───────────┼────────────────────────────────────────────────────────────────────\n action    │ approve                                                            \n",
            data_html:
              "<table><tr><th>approved</th><td>True</td></tr><tr><th>reason</th><td>Both text and image content passed safety checks with high safety scores (0.95 each). No categories were flagged in either text or image analysis.</td></tr><tr><th>action</th><td>approve</td></tr></table>",
            extra: {},
          },
        ],
      },
      ...
      usage: {
        ...
        subtree_total_tokens: 1003,
        subtree_cost: 0.004161,
        subtree_cost_input: 0.002721,
        subtree_cost_output: 0.00144,
        subtree_by_model: [
          {
            inference_model_name: "claude-4.6-sonnet",
            inference_model_id: "global.anthropic.claude-sonnet-4-6",
