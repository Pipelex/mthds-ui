...
export const DRY_THREE_WAY_PARALLEL = {
  graph_id: "8fe9a4e4-3bf0-4bc4-b37e-70ef8b226b93",
  created_at: "2026-08-14T09:49:23.258539Z",
  pipeline_ref: { domain: "report_generation", main_pipe: "multi_format_report", entrypoint: null },
  nodes: [
    {
      id: "8fe9a4e4-3bf0-4bc4-b37e-70ef8b226b93:node_0",
      kind: "controller",
      ...
      skip_reason: null,
      timing: {
        started_at: "2026-08-14T09:49:23.258539Z",
        ended_at: "2026-08-14T09:49:23.435096Z",
        duration: 0.176557,
      },
      io: {
        inputs: [
          {
            ...
            size: null,
            digest: "2bFaX",
            data: { text: "FfDDGmdGVBochhxBiNxm" },
            data_text:
              "FfDDGmdGVBochhxBiNxm                                                                                \n",
            data_html: "FfDDGmdGVBochhxBiNxm",
            extra: {},
          },
        ],
        outputs: [
    ...
    {
      id: "8fe9a4e4-3bf0-4bc4-b37e-70ef8b226b93:node_1",
      kind: "operator",
      ...
      skip_reason: null,
      timing: {
        started_at: "2026-08-14T09:49:23.277384Z",
        ended_at: "2026-08-14T09:49:23.305036Z",
        duration: 0.027652,
      },
      io: {
        inputs: [
    ...
    {
      id: "8fe9a4e4-3bf0-4bc4-b37e-70ef8b226b93:node_2",
      kind: "controller",
      ...
      skip_reason: null,
      timing: {
        started_at: "2026-08-14T09:49:23.312244Z",
        ended_at: "2026-08-14T09:49:23.393330Z",
        duration: 0.081086,
      },
      io: {
        inputs: [
        ...
        outputs: [
          ...
          },
          {
            ...
            size: null,
            digest: "exugE",
            data: { json_obj: { SJMICgxQqFEXYAbENIph: "26" } },
            data_text: '{\n    "SJMICgxQqFEXYAbENIph": "26"\n}\n',
            data_html: "<table ><tr><th>SJMICgxQqFEXYAbENIph</th><td>26</td></tr></table>",
            extra: {},
          },
          {
            name: "narrative",
          ...
          },
          {
            ...
            data: {
              ...
              table_data: { json_obj: { SJMICgxQqFEXYAbENIph: "26" } },
              narrative: {
                text: "DRY RUN: llm_gen_text • llm_setting=LLMSetting(llm_handle=claude-4.6-sonnet, temperature=0.5, max_tokens=None, prompting_target=None) • prompt=LLM Prompt:\n    user_text:\n    Write a clear narrative describing these insights:\n\n<insight>\nDRY RUN: llm_gen_text • llm_setting=LLMSetting(llm_handle=claude-4.6-sonnet, temperature=0.5, max_tokens=None, prompting_target=None) • prompt=LLM Prompt:\n    user_text:\n    Analyze the followin\n    ",
              },
            },
            ...
            data_html:
              "<table><tr><th>chart_spec</th><td>DRY RUN: llm_gen_text • llm_setting=LLMSetting(llm_handle=claude-4.6-sonnet, temperature=0.5, max_tokens=None, prompting_target=None) • prompt=LLM Prompt:\n    user_text:\n    Create a chart specification for visualizing these insights:\n\n&lt;insight&gt;\nDRY RUN: llm_gen_text • llm_setting=LLMSetting(llm_handle=claude-4.6-sonnet, temperature=0.5, max_tokens=None, prompting_target=None) • prompt=LLM Prompt:\n    user_text:\n    Analyze th\n    </td></tr><tr><th>table_data</th><td><table ><tr><th>SJMICgxQqFEXYAbENIph</th><td>26</td></tr></table></td></tr><tr><th>narrative</th><td>DRY RUN: llm_gen_text • llm_setting=LLMSetting(llm_handle=claude-4.6-sonnet, temperature=0.5, max_tokens=None, prompting_target=None) • prompt=LLM Prompt:\n    user_text:\n    Write a clear narrative describing these insights:\n\n&lt;insight&gt;\nDRY RUN: llm_gen_text • llm_setting=LLMSetting(llm_handle=claude-4.6-sonnet, temperature=0.5, max_tokens=None, prompting_target=None) • prompt=LLM Prompt:\n    user_text:\n    Analyze the followin\n    </td></tr></table>",
            extra: {},
          },
        ],
      },
    ...
    {
      id: "8fe9a4e4-3bf0-4bc4-b37e-70ef8b226b93:node_3",
      kind: "operator",
      ...
      skip_reason: null,
      timing: {
        started_at: "2026-08-14T09:49:23.320019Z",
        ended_at: "2026-08-14T09:49:23.329994Z",
        duration: 0.009975,
      },
      io: {
        inputs: [
    ...
    {
      id: "8fe9a4e4-3bf0-4bc4-b37e-70ef8b226b93:node_4",
      kind: "operator",
      ...
      skip_reason: null,
      timing: {
        started_at: "2026-08-14T09:49:23.334131Z",
        ended_at: "2026-08-14T09:49:23.354364Z",
        duration: 0.020233,
      },
      io: {
        inputs: [
    ...
    {
      id: "8fe9a4e4-3bf0-4bc4-b37e-70ef8b226b93:node_5",
      kind: "operator",
      ...
      skip_reason: null,
      timing: {
        started_at: "2026-08-14T09:49:23.361271Z",
        ended_at: "2026-08-14T09:49:23.378142Z",
        duration: 0.016871,
      },
      io: {
        inputs: [
    ...
    {
      id: "8fe9a4e4-3bf0-4bc4-b37e-70ef8b226b93:node_6",
      kind: "operator",
      ...
      skip_reason: null,
      timing: {
        started_at: "2026-08-14T09:49:23.408451Z",
        ended_at: "2026-08-14T09:49:23.430441Z",
        duration: 0.02199,
      },
      io: {
        inputs: [
  ...
  edges: [
    {
      id: "8fe9a4e4-3bf0-4bc4-b37e-70ef8b226b93:edge_0",
      source: "8fe9a4e4-3bf0-4bc4-b37e-70ef8b226b93:node_0",
      target: "8fe9a4e4-3bf0-4bc4-b37e-70ef8b226b93:node_1",
      kind: "contains",
      optional: false,
      label: null,
    ...
    {
      id: "8fe9a4e4-3bf0-4bc4-b37e-70ef8b226b93:edge_1",
      source: "8fe9a4e4-3bf0-4bc4-b37e-70ef8b226b93:node_0",
      target: "8fe9a4e4-3bf0-4bc4-b37e-70ef8b226b93:node_2",
      kind: "contains",
      optional: false,
      label: null,
      source_stuff_digest: null,
    ...
    {
      id: "8fe9a4e4-3bf0-4bc4-b37e-70ef8b226b93:edge_2",
      source: "8fe9a4e4-3bf0-4bc4-b37e-70ef8b226b93:node_2",
      target: "8fe9a4e4-3bf0-4bc4-b37e-70ef8b226b93:node_3",
      kind: "contains",
      optional: false,
      label: null,
      source_stuff_digest: null,
    ...
    {
      id: "8fe9a4e4-3bf0-4bc4-b37e-70ef8b226b93:edge_3",
      source: "8fe9a4e4-3bf0-4bc4-b37e-70ef8b226b93:node_2",
      target: "8fe9a4e4-3bf0-4bc4-b37e-70ef8b226b93:node_4",
      kind: "contains",
      optional: false,
      label: null,
      source_stuff_digest: null,
    ...
    {
      id: "8fe9a4e4-3bf0-4bc4-b37e-70ef8b226b93:edge_4",
      source: "8fe9a4e4-3bf0-4bc4-b37e-70ef8b226b93:node_2",
      target: "8fe9a4e4-3bf0-4bc4-b37e-70ef8b226b93:node_5",
      kind: "contains",
      optional: false,
      label: null,
      source_stuff_digest: null,
    ...
    {
      id: "8fe9a4e4-3bf0-4bc4-b37e-70ef8b226b93:edge_5",
      source: "8fe9a4e4-3bf0-4bc4-b37e-70ef8b226b93:node_0",
      target: "8fe9a4e4-3bf0-4bc4-b37e-70ef8b226b93:node_6",
      kind: "contains",
      optional: false,
      label: null,
      source_stuff_digest: null,
    ...
    {
      id: "8fe9a4e4-3bf0-4bc4-b37e-70ef8b226b93:asm_edge_0",
      source: "8fe9a4e4-3bf0-4bc4-b37e-70ef8b226b93:node_1",
      target: "8fe9a4e4-3bf0-4bc4-b37e-70ef8b226b93:node_2",
      kind: "data",
      optional: false,
      label: "insight",
    ...
    {
      id: "8fe9a4e4-3bf0-4bc4-b37e-70ef8b226b93:asm_edge_1",
      source: "8fe9a4e4-3bf0-4bc4-b37e-70ef8b226b93:node_1",
      target: "8fe9a4e4-3bf0-4bc4-b37e-70ef8b226b93:node_3",
      kind: "data",
      optional: false,
    ...
    {
      id: "8fe9a4e4-3bf0-4bc4-b37e-70ef8b226b93:asm_edge_2",
      source: "8fe9a4e4-3bf0-4bc4-b37e-70ef8b226b93:node_1",
      target: "8fe9a4e4-3bf0-4bc4-b37e-70ef8b226b93:node_4",
      kind: "data",
      optional: false,
    ...
    {
      id: "8fe9a4e4-3bf0-4bc4-b37e-70ef8b226b93:asm_edge_3",
      source: "8fe9a4e4-3bf0-4bc4-b37e-70ef8b226b93:node_1",
      target: "8fe9a4e4-3bf0-4bc4-b37e-70ef8b226b93:node_5",
      kind: "data",
      optional: false,
    ...
    {
      id: "8fe9a4e4-3bf0-4bc4-b37e-70ef8b226b93:asm_edge_4",
      source: "8fe9a4e4-3bf0-4bc4-b37e-70ef8b226b93:node_2",
      target: "8fe9a4e4-3bf0-4bc4-b37e-70ef8b226b93:node_6",
      kind: "data",
      optional: false,
    ...
    {
      id: "8fe9a4e4-3bf0-4bc4-b37e-70ef8b226b93:asm_edge_5",
      source: "8fe9a4e4-3bf0-4bc4-b37e-70ef8b226b93:node_2",
      target: "8fe9a4e4-3bf0-4bc4-b37e-70ef8b226b93:node_6",
      kind: "data",
      optional: false,
    ...
    {
      id: "8fe9a4e4-3bf0-4bc4-b37e-70ef8b226b93:asm_edge_6",
      source: "8fe9a4e4-3bf0-4bc4-b37e-70ef8b226b93:node_2",
      target: "8fe9a4e4-3bf0-4bc4-b37e-70ef8b226b93:node_6",
      kind: "data",
      optional: false,
    ...
    {
      id: "8fe9a4e4-3bf0-4bc4-b37e-70ef8b226b93:asm_edge_7",
      source: "8fe9a4e4-3bf0-4bc4-b37e-70ef8b226b93:node_3",
      target: "8fe9a4e4-3bf0-4bc4-b37e-70ef8b226b93:node_2",
      kind: "parallel_combine",
      optional: false,
      label: null,
      source_stuff_digest: "nqUBb",
      target_stuff_digest: "WjzBK",
      meta: {},
    },
    {
      id: "8fe9a4e4-3bf0-4bc4-b37e-70ef8b226b93:asm_edge_8",
      source: "8fe9a4e4-3bf0-4bc4-b37e-70ef8b226b93:node_4",
      target: "8fe9a4e4-3bf0-4bc4-b37e-70ef8b226b93:node_2",
      kind: "parallel_combine",
      optional: false,
      label: null,
      source_stuff_digest: "exugE",
      target_stuff_digest: "WjzBK",
      meta: {},
    },
    {
      id: "8fe9a4e4-3bf0-4bc4-b37e-70ef8b226b93:asm_edge_9",
      source: "8fe9a4e4-3bf0-4bc4-b37e-70ef8b226b93:node_5",
      target: "8fe9a4e4-3bf0-4bc4-b37e-70ef8b226b93:node_2",
      kind: "parallel_combine",
      optional: false,
      label: null,
      source_stuff_digest: "FVZwh",
      target_stuff_digest: "WjzBK",
      meta: {},
    },
  ],
