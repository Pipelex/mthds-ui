...
// LIVE specs are intentionally kept out of mockGraphSpec.ts so Storybook browser
// smoke stories can import the DRY catalog without loading the full LIVE fixture set.
