...
export const CvMatching: Story = makeStory(DRY_RUN_CATALOG.DRY_CV_MATCHING.spec);
export const CvBatchScreening: Story = makeStory(DRY_RUN_CATALOG.DRY_CV_BATCH_SCREENING.spec);
export const CvAnalyzer: Story = makeStory(DRY_RUN_CATALOG.DRY_CV_ANALYZER.spec);
export const RfpQualifier: Story = makeStory(DRY_RUN_CATALOG.DRY_RFP_QUALIFIER.spec);
