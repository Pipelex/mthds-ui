...
import { truncLongNameShortConcept } from "./edgeCaseData";

const meta: Meta<typeof GraphViewer> = {
  title: "Graph/PipeCard/EdgeCases/TruncLongNameShortConcept",
...
const spec = toGraphSpec(truncLongNameShortConcept);
